 ...
 *
 */
#define MY_Z_PROBE_OFFSET_FROM_EXTRUDER -2.03      
...
#define STRING_CONFIG_H_AUTHOR "(diogoribeiro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Queen Needs'a Groom"
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10),  10, 10 }
